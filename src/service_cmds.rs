...
mod tests {
    ...
    fn test_filter_services_by_skip_list_keeps_non_skipped() {
        ...
        let skip = ["ory".to_string()];
        let filtered: Vec<_> = services
            .into_iter()
            .filter(|s| !skip.contains(&s.namespace))
            .collect();
    ...
    #[test]
    fn test_parse_cpu_milli_whole_number() {
        assert_eq!(parse_cpu_milli("2"), 2000);
    }

    #[test]
    fn test_parse_cpu_milli_m_suffix() {
        assert_eq!(parse_cpu_milli("500m"), 500);
    }

    #[test]
    fn test_parse_cpu_milli_n_suffix() {
        assert_eq!(parse_cpu_milli("1000000000n"), 1000);
    }

    #[test]
    fn test_parse_cpu_milli_float() {
    ...
    #[test]
    fn test_parse_memory_bytes_plain() {
    ...
    #[test]
    fn test_parse_memory_bytes_gi() {
        assert_eq!(parse_memory_bytes("1Gi"), 1024 * 1024 * 1024);
    }

    #[test]
    fn test_parse_memory_bytes_k() {
        assert_eq!(parse_memory_bytes("1K"), 1000);
    }
